...
<head>
    ...
    <title>Kategoriler • <?=$dataname["websitename"]?></title>
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h3 class="card-title">
                                            <td> <a href="category_add.php" class="btn btn-sm btn-success">Yeni Kategori
                                                    Ekle</a>
                                            </td>
                                        </h3>
                                    </div>
                                    ...
                                    <div class="card-body">
                                        <table id="example2" class="table table-bordered table-hover">
                                            ...
                                            $sql2 = $config -> prepare("SELECT * FROM categories");
                                            $sql2 -> execute();
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div style="display: flex;">
                                                            <a href="category_edit.php?id=<?= $result['cat_id'] ?>"
                                                                class="btn btn-sm btn-success">Düzenle</a>

                                                            <form class="ml-1" action="controller/category_controller.php"
                                                                method="POST"
