                    ...
                    <div class="card card-default">
                        ...
                        <div class="card-body">
                            ...
                            <form action="controller/blogs_controller.php" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="col-12 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="blog_title"
                                                placeholder="Blog Başlığı" value="<?=$result['blog_title']?>" required>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <input type="submit" name="edit_blog" value="Güncelle" class="btn btn-primary">
                                <input type="hidden" name="islem" value="update" class="btn btn-primary">
                                <input type="hidden" name="blogID" value="<?= $blogID ?>" class="btn btn-primary">
